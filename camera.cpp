...
void Camera::lookAt(Vec3f eye, Vec3f at, Vec3f up) {
	...
	Mat4f rmatrix = {				// matrix rotation in hint
		u[0], u[1], u[2], 0,
		v[0], v[1], v[2], 0,
		n[0], n[1], n[2], 0,
		0, 0, 0, 1
	...
	rmatrix.getGLMatrix(resultMatrix);
	glMultMatrixf(resultMatrix);
	glTranslated(-eye[0], -eye[1] - 1, -eye[2] - 1);	// I subtracted from these values to zoom out 
														// a little for the animation
}
